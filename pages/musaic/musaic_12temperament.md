...
{% include image.html file='musaic/alpha-gamma.png' alt='cycles-1-5-7-11' caption='cycles-1-5-7-11' %}
...
## P vs PC vs PCS
  ...
  * Pitch Class Set (**PCS**) refers to a set of ordered heights classes, without duplicate element (example : `{C, E, G}`)
